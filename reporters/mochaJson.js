 ...
 * 
 * @param pattern A regex that captures linked test cases. The pattern must return the actual test case identifier in the first capturing group, and will subsequently be applied on the test case name.
 */
